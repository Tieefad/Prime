...
function Events({ darkMode, setDarkMode, onNavigate }) {
  ...
  const events = [
    {
      id: 1,
      title: "BPL 2025 — Dhaka Capitals vs Chattogram",
      location: "Sher-e-Bangla Stadium, Mirpur",
      date: "15 Feb 2026",
      price: "৳ 500",
      rating: 4.9,
      badge: "🏏 Cricket",
    ...
    {
      id: 2,
      title: "Shironamhin Live in Concert",
    ...
    {
      id: 3,
      title: "Dhaka Literary Festival 2026",
    ...
    {
      id: 5,
      title: "Stand-up Comedy Night — Dhaka",
      location: "Navana Tower, Gulshan",
      date: "18 Mar 2026",
      price: "৳ 600",
      rating: 4.6,
      badge: "🎤 Comedy",
    ...
    },
    {
      ...
      location: "Bashundhara Convention Centre",
      date: "25 Mar 2026",
      price: "৳ 300",
      rating: 4.8,
      badge: "💻 Tech",
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        textAlign: "center",
        background: darkMode
          ? "linear-gradient(135deg, #0a0f1e, #0f172a, #1a1040)"
          : "linear-gradient(135deg, #e0f2fe, #f0f9ff, #ede9fe)",
      }}>
        <div style={{
          ...
          fontSize: "13px", color: theme.primary, fontWeight: "600", marginBottom: "20px",
        }}>
          ...
          {events.map((e, i) => (
            ...
            >
              ...
              <div style={{ padding: "20px" }}>
                <div style={{
                  display: "inline-block", background: `${e.color}22`,
                  color: e.color, fontSize: "12px", fontWeight: "700",
                  padding: "4px 10px", borderRadius: "999px", marginBottom: "12px",
                }}>
                  {e.badge}
                </div>
                <h3 style={{ fontSize: "16px", fontWeight: "700", marginBottom: "12px", lineHeight: "1.4", color: theme.text }}>
                  {e.title}
                </h3>
